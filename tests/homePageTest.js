...
describe('HomePage Tests', function () {
  ...
  //     const heroSubtitle = await driver.findElement(By.css('div > p')).getText();
  //     assert.strictEqual(heroSubtitle, 'Join us today and enjoy exclusive benefits.');
  //   });
  ...
  //     const learnMoreButton = await driver.findElement(By.xpath("//button[contains(text(), 'Learn More')]"));
  ...
  //     const topSellerTitle = await driver.findElement(By.xpath("//h1[contains(text(),'Check Out Our Top Seller')]")).getText();
  ...
  //     const visibleCards = await driver.findElements(By.css('.ant-carousel .ant-col')); // Ensure this matches the visible card selector
  ...
  //     const whyJoinUs = await driver.findElement(By.xpath("//h3[contains(text(),'Why Join Us?')]"));
  //     assert(whyJoinUs.isDisplayed());
  //   });

  //   it('should display Get Started Today section', async () => {
  //     const getStartedToday = await driver.findElement(By.xpath("//h3[contains(text(),'Get Started Today')]"));
